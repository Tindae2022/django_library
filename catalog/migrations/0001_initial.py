    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TimeField(help_text='Enter a brief description of the book', max_length=100)),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a group Genre', to='catalog.genre'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
